...
import hu.elte.inf.mbalassi.msc.hadoop.tricnt.DirectedTriangleCounter.Counters;

public class TrianglesReduce extends Reducer<LongWritable, Text, NullWritable, NullWritable> {

  public void reduce(LongWritable id, Iterable<Text> destsOrTri, Context context)
