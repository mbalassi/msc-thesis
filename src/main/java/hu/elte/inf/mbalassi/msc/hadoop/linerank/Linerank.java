...
/**
 * This class implements calculating the LineRank scores of nodes of a graph on Hadoop. The input
...
public class Linerank {
    ...
    public static void main(String[] args) throws Exception {
        ...
        conf.setLong(EDGE_COUNT, job.getCounters().findCounter(Counter.EDGE_COUNT).getValue());
        ...
        while (true) {
            ...
            if (job.getCounters().findCounter(Counter.MORE_ITERATIONS).getValue() == 0) {
                input = tempFileOut;
                break;
            }
        }
